       ...
       <div class="container">
		   ...
		   <form id="form" action="./registerfunction.php" method="POST" enctype="multipart/form-data" >
			   ...
			   <div class="page">
				   ...
				   <div>
					   <input type="radio" name="newsletter" id="agree" class="form-check-input" value="1" checked /><label for="agreee" class="form-check-label">I agree to get newsletter</label>
					    <br/>
					   <input type="radio" name="newsletter" id="noagreee" class="form-check-input" value="0" /><label for="noagreee" class="form-check-label">I do not agree to get newsletter</label>
                   </div>
			   </div>
