...
echo "<pre>".print_r(array_diff($colors1,$colors2,$colors3),"true")."</pre>"; //none
...
$colors = ["red","green"];
echo "<pre>".print_r(array_pad($colors,5,"blue"),"true")."</pre>"; //  [0] => blue [1] => green [2] => blue [3] => blue [4] => blue
